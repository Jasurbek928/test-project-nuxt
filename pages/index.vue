                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Website</th>
                        ...
                        <tbody class="bg-white">
                                <tr v-for="(user,idx) in users" :key="idx" @click="userProfile">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{user.username}}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">{{user.email}}</td>

                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{{user.address.street}}</td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{{user.address.city}}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-blue-900 text-sm leading-5">{{user.website}}</td>
                         <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <nuxt-link :to="`user/${user.id}`"><button  class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">Profile</button></nuxt-link>
                        </td>
                          </tr>
                        </tbody>
                    </table>
